public class RomanNumeralsTest
{
    ...
    public static void main(String[] args)
    {
        ...
        number2.setIntegers();
        System.out.print(number2.getArabicNum() + "\n");
        System.out.print(number2.getThousands() + "\n");
        System.out.print(number2.getHundreds() + "\n");
        System.out.print(number2.getTens() + "\n");
        System.out.print(number2.getOnes() + "\n");
    }
}